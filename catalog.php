            ...
            <div class="product-card">
                ...
                <div class="cart-button-container" style="padding: 0 15px 15px;">
                    ...
                    <?php elseif (!isset($_SESSION['user_id'])): ?>
                        <a href="login.php" class="btn login-buy-btn" style="width: 100%; display: block; text-align: center;">Войти, чтобы купить</a>
                    <?php else: ?>
...
</html> $pdo->query("SELECT * FROM categories ORDER BY name")->fetchAll();
